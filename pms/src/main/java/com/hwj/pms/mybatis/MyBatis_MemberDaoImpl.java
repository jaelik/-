...
public class MyBatis_MemberDaoImpl implements MyBatis_MemberDao{
	...
	public MemberVO findMember(Integer seq) {
		return sqlsession.selectOne(NAME_SPACE + ".findMember",seq);
	}

	@Override
	public Integer updateStudent(MemberVO membervo) {
		return sqlsession.update(NAME_SPACE + ".updateStudent",membervo);
	}
	...
	@Override
	public List<MemberVO> dynamicStudent(String value) {
		return sqlsession.selectList(NAME_SPACE + ".dynamicStudent",value);
	}

	@Override
	public Integer insertMember(MemberVO memberVO) {
		return sqlsession.insert(NAME_SPACE + ".insertMember",memberVO);
	}
